...
export function CrmDashboard({ companyId }: CrmDashboardProps) {
  ...
  const crmModules = [
    ...
    },
    {
      ...
      icon: Mail,
      href: '/workspace/crm-fomo/campaigns',
    ...
    },
    {
      ...
      icon: Zap,
      href: '/workspace/crm-fomo/automation',
    ...
    },
    {
      ...
      icon: BarChart3,
      href: '/workspace/crm-fomo/reports',
      color: 'bg-primary'
    },
    {
      title: 'Documentación',
      ...
      icon: BookOpen,
      href: '/workspace/crm-fomo/documentation',
    ...
    },
    {
      ...
      icon: Settings,
      href: '/workspace/crm-fomo/settings',
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">CRM-FOMO Dashboard</h1>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Button asChild>
                  <Link href={buildUrl("/workspace/crm-fomo/leads")}>
                    Gestionar Contact Leads
                  </Link>
                </Button>
                <Button variant="outline" asChild>
                  <Link href={buildUrl("/workspace/crm-fomo/documentation")}>
                    Ver Documentación
                  </Link>
                </Button>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <Button asChild className="w-full">
                <Link href={buildUrl("/workspace/crm-fomo/leads?action=create")}>
                  Crear Lead
                </Link>
              </Button>
            </CardContent>
