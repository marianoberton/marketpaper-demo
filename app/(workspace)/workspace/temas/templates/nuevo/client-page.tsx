...
export default function NuevoTemplateClientPage() {
  ...
  const removeTask = (index: number) => {
    ...
    // Clean up checklist input for removed task
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Nuevo Template</h1>
          <p className="text-muted-foreground">
            Define una plantilla reutilizable con tareas predefinidas
          </p>
        </div>
      </div>
