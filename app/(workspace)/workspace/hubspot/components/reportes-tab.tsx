...
import { getReportData, type ReportData, type EnrichedDeal } from '@/actions/hubspot-analytics'
...
export function ReportesTab({ companyId, pipelineId, refreshKey, dateRange }: ReportesTabProps) {
  ...
  // Top clients chart data with colors
  const topClientsData = data.topClients.map(c => ({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <MetricsChart
          title="Deals por Mes"
          description="Cantidad y monto de negocios creados por mes"
        ...
        <MetricsChart
          title="m2 por Mes"
          description="Metros cuadrados presupuestados por mes"
          data={data.monthlyData}
        ...
        <MetricsChart
          ...
          description="Proporcion de deals ganados, perdidos y en proceso"
          data={data.stageDistribution}
          series={[{ name: 'Porcentaje', key: 'value' }]}
          chartType="pie"
        ...
        <MetricsChart
          ...
          description="Clientes con mayor volumen de negocios"
          data={topClientsData}
          series={[{ name: 'Monto', key: 'monto', color: '#f97316' }]}
          chartType="bar"
          formatterType="currency"
          height={280}
          showLegend={false}
