...
// GET /api/admin/nexus/projects/[projectId]/agents/[agentId]/stats
export async function GET(
  ...
  try {
    ...
    const res = await fetch(`${NEXUS_URL}/api/v1/projects/${projectId}/agents/${agentId}/stats`, {
      method: 'GET',
    ...
    console.error('Error in GET /api/admin/nexus/agents/[agentId]/stats:', error)
