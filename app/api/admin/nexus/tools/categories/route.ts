...
// GET /api/admin/nexus/tools/categories
export async function GET(request: NextRequest) {
  try {
    ...
    const res = await fetch(`${NEXUS_URL}/api/v1/tools/categories`, {
      method: 'GET',
    ...
    console.error('Error in GET /api/admin/nexus/tools/categories:', error)
