...
-- Migración: 0020_create_unified_crm_system.sql
-- =============================================
...
INSERT INTO lead_scoring_rules (
    id, company_id, rule_name, rule_type, channel_type, conditions, score_impact, weight
) VALUES 
-- Reglas que se aplicarán a todas las empresas (usaremos una función para esto después)
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Email válido', 'base', NULL, '{"has_valid_email": true}', 15, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Teléfono presente', 'base', NULL, '{"has_phone": true}', 10, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Empresa presente', 'base', NULL, '{"has_company": true}', 10, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'LinkedIn Premium', 'channel', 'linkedin_ads', '{"premium_channel": true}', 20, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Referido', 'channel', 'referral', '{"referral_bonus": true}', 25, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Web Form Complete', 'channel', 'web_form', '{"form_complete": true}', 15, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'High Intent Campaign', 'context', NULL, '{"campaign_intent": "high"}', 10, 1.0),
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Recent Lead', 'timing', NULL, '{"hours_since_capture": {"<": 24}}', 10, 1.0);

-- =============================================
-- FUNCIONES DE UTILIDAD
-- =============================================

-- Función para migrar contact_leads existentes
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 0020_create_unified_crm_system.sql completada exitosamente';
