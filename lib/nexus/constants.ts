...
export const AVAILABLE_TOOLS = [
  ...
  { id: 'web-search', label: 'Web Search', description: 'Búsqueda en la web', category: 'integration' },
  { id: 'knowledge-search', label: 'Knowledge Search', description: 'Búsqueda semántica en base de conocimiento', category: 'memory' },
  { id: 'read-file', label: 'Leer Archivo', description: 'Leer archivos del proyecto', category: 'memory' },
  { id: 'send-notification', label: 'Notificaciones', description: 'Enviar notificaciones multi-canal', category: 'communication' },
  { id: 'send-email', label: 'Enviar Email', description: 'Enviar emails', category: 'communication' },
  { id: 'send-channel-message', label: 'Mensaje de Canal', description: 'Enviar mensajes por WhatsApp/Telegram/Slack', category: 'communication' },
